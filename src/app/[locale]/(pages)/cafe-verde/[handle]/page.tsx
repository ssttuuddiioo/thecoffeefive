...
const C = {
  es: {
    ...
    notasCata: ['Frutas tropicales', 'Cítrico brillante', 'Final limpio'],
    perfilDescripcion:
    ...
    masl: 'msnm',
    breadcrumbOrigen: 'Origen',
    factVarietal: 'Variedad',
    factProceso: 'Proceso',
    factRegion: 'Región',
    factMunicipio: 'Municipio',
    factFinca: 'Finca',
    factAltitude: 'Altura',
    factNorma: 'Norma',
    factAvailable: 'Disponible',
    factPrice: 'Precio',
    enquiryTitle: '¿Interesado en este lote?',
    enquiryBody: 'Contáctanos directamente para hablar sobre disponibilidad, precio y envío.',
    enquire: 'Consultar',
    email: 'Email',
    whatsapp: 'WhatsApp',
    ubicacionLabel: {
  ...
  en: {
    ...
    metodo: 'Method',
    procesoDescripcion:
      'Cherries hand-picked at peak ripeness. Controlled fermentation of 48–60 hours with temperature monitoring. Dried on raised beds for 15–20 days until reaching 10.5–11% moisture. The entire process is supervised by the Coffee Five team.',
    notasCata: ['Tropical fruit', 'Bright citrus', 'Clean finish'],
    perfilDescripcion:
      'Tropical fruit notes, bright citric acidity, medium body with a clean, lingering finish. A coffee with character that shines in filter methods as well as espresso. Complexity that evolves as the cup cools.',
    masl: 'masl',
    breadcrumbOrigen: 'Origin',
    factVarietal: 'Varietal',
    factProceso: 'Process',
    factRegion: 'Region',
    factMunicipio: 'Municipality',
    factFinca: 'Farm',
    factAltitude: 'Altitude',
    factNorma: 'Grade',
    factAvailable: 'Available',
    factPrice: 'Price',
    enquiryTitle: 'Interested in this lot?',
    enquiryBody: 'Contact us directly to discuss availability, pricing, and shipping.',
    enquire: 'Enquire',
    email: 'Email',
    whatsapp: 'WhatsApp',
    ubicacionLabel: {
...
export default async function GreenCoffeeLotPage({ params }: Props) {
  ...
  const notaFinca = lotNotaFinca(lot, locale);
  ...
  const ubicacionLabel = c.ubicacionLabel;
      ...
      <div className="pb-24 -mt-20 md:-mt-24">
        ...
        <div className="relative w-full h-screen mb-12 md:mb-16">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-6 md:px-12 lg:px-20 pb-10 md:pb-16">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/80 tracking-wide mb-5">
              {lot.region}, {'municipio' in lot ? lot.municipio : lot.finca} · {lot.altura} {c.masl}
            </p>
        ...
        <div className="max-w-5xl mx-auto px-5 md:px-8 mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
            {/* Proceso */}
            <div>
              <SectionHeading>{c.proceso}</SectionHeading>
              <div className="mb-6 min-h-[3rem] flex flex-col justify-end">
                <p className="text-[10px] tracking-[0.15em] uppercase text-gray-400 mb-1.5">{c.metodo}</p>
                <p className="text-sm font-semibold text-coffee-black">{procesoName}</p>
              </div>
              <p className="text-sm text-gray-600 leading-relaxed">
                {c.procesoDescripcion}
              </p>
            </div>
            {/* Perfil */}
            <div>
              <SectionHeading>{c.perfil}</SectionHeading>
              <div className="flex flex-wrap gap-2 mb-6 min-h-[3rem] items-end">
                {c.notasCata.map((note) => (
          ...
          <div className="max-w-5xl mx-auto px-5 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              ...
              <div className="grid grid-cols-2 gap-px bg-gray-300/50">
                {[
                  { label: c.factVarietal, value: lot.variedad },
                  { label: c.factProceso, value: procesoName },
                  { label: c.factRegion, value: `${lot.region}, Colombia` },
                  { label: 'municipio' in lot ? c.factMunicipio : c.factFinca, value: 'municipio' in lot ? lot.municipio : lot.finca },
                  { label: c.factAltitude, value: `${lot.altura} ${c.masl}` },
                  { label: c.factNorma, value: lot.puntaje },
                  { label: c.factAvailable, value: lot.weight },
                  { label: c.factPrice, value: lot.price, highlight: true },
                ].map((item) => (
        ...
        <div className="max-w-5xl mx-auto px-5 md:px-8">
          <div className="bg-gray-50 rounded-lg p-8 md:p-10">
            <p className="text-lg font-bold text-coffee-black mb-2">{c.enquiryTitle}</p>
            <p className="text-sm text-gray-500 mb-6">{c.enquiryBody}</p>
