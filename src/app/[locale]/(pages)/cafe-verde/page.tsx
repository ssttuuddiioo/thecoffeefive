...
import { mockGreenLots, procesoLabel } from '@/lib/mock-data';
...
export default function CafeVerdePage() {
  ...
  }, [keyword, selProceso, selVariedad, selRegion, selUbicacion, selPuntaje, selAltura, selFinca, weightRange, UBICACION_LABELS, locale]);
  ...
  }, [keyword, selProceso, selVariedad, selRegion, selUbicacion, selPuntaje, selAltura, selFinca, UBICACION_LABELS, locale]);
